const translations = {
    en: {
        ...
        aboutMe: "About Me",
        disclaimer: "Disclaimer: This web application and its recycling information guide were created as a learning project and should be used for educational purposes only.",
    ...
    zh: {
        ...
        electronics: "电子产品",
        aboutMe: "关于我",
        disclaimer: "免责声明：此网络应用程序及其回收信息指南是作为学习项目创建的，仅供教育目的使用。",
